    ...
    <div className="bg-[#03071c] text-white font-source-sans-pro">
      ...
      <header className="fixed w-full z-50 bg-[#03071c] shadow-lg py-4">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          {/* Desktop Menu */}
          <div className="bg-gray-500 border border-gray-300 hidden md:flex rounded-lg p-4">
      ...
      <section className="h-screen bg-[#03071c] flex flex-col justify-center items-center text-center">
        ...
        <img className="absolute -z-8  " src="./assets/svg/Ellipse 2.svg" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 md:gap-x-36 md:gap-y-20 gap-6">
        ...
        <div className="relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-96">
          <div className="relative h-56 m-2.5 overflow-hidden text-white rounded-md">
            <img
              src="./assets/png/web-and-mobile.jpg"
              alt="card-image"
            />
          </div>
          <div className="p-4">
        ...
        <div className="relative flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-96">
          <div className="relative h-56 m-2.5 overflow-hidden text-white rounded-md">
            <img
              src="./assets/png/devops.png"
              alt="card-image"
            />
          </div>
          <div className="p-4">
            <h6 className="mb-6 text-slate-800 text-xl text-center  font-semibold">
              Devops
